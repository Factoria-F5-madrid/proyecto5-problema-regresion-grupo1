...
REVENUE_PREDICT_ENDPOINT = os.getenv("PREDICT_REVENUE_ENDPOINT", "/predict/revenue")
DISCOUNT_PREDICT_ENDPOINT = os.getenv(
    "DISCOUNT_PREDICTION_ENDPOINT", "/predict/discount"
)
METADATA_ENDPOINT = "/metadata"

# Define la ruta a las imágenes
AISLE_IMG = PROJECT_ROOT / os.getenv("AISLE_IMG")


# --- Funciones para la API ---
@st.cache_data(ttl=3600)  # Cachea la respuesta por una hora
def get_metadata():
    try:
...
# Cargar las listas desde los metadatos de la API
...
with tab2:
    ...
    # Manejar la selección del producto para deshabilitar la categoría
